...
@RestController
@RequestMapping("/api/care-cloud-calendar-kafka")
public class CareCloudCalendarKafkaResource {
    private final Logger log = LoggerFactory.getLogger(CareCloudCalendarKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CareCloudCalendarKafkaResource(KafkaProperties kafkaProperties) {
